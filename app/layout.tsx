...
const organizationSchema = { '@context': 'https://schema.org', '@type': 'Organization', name: 'Cadu AI', url: 'https://caduai.com.br', logo: 'https://caduai.com.br/og.png', description: 'Inteligência de receita e atendimento por IA para imobiliárias.', sameAs: ['https://instagram.com/caduai.br'] };
