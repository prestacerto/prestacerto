...
export const CERTO_PRODUCTS: ProductConfig[] = [
  ...
  },
  {
    ...
    name: "ACORDO CERTO",
    icon: "🤝",
    description: "Contrato do projeto com aceite registrado dos dois lados. O pagamento segue direto entre cliente e profissional",
    category: "payments",
    phase: 3,
    status: "planned",
  ...
  },
  {
    ...
    icon: "📍",
    description: "Etapas com valor e prazo combinados e aceitos por ambos. A Presta registra o acordo, não guarda o dinheiro",
    category: "payments",
    phase: 3,
    status: "planned",
    pricingType: "commission",
