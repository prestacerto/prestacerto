...
export function PublicPortfolio({ data }: { data: PortfolioData }) {
  ...
  const portfolioUrl = `${siteUrl}/portfolio/${encodeURIComponent(data.portfolio.url_slug)}`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
          ...
          <div className="md:col-span-2">
            ...
            <div className="grid grid-cols-3 gap-6 mb-8">
              <div>
                <div className="text-3xl font-bold">{data.stats.reviews_count}</div>
                <div className="text-sm opacity-70">Avaliações recebidas</div>
              </div>
              <div>
              ...
              <div>
                <div className="text-2xl font-bold">{new Date(data.stats.member_since).toLocaleDateString('pt-BR', { month: 'short', year: 'numeric', timeZone: 'UTC' })}</div>
                <div className="text-sm opacity-70">No PrestaCerto desde</div>
              </div>
            </div>
            ...
            <div className="flex gap-4 flex-wrap">
              ...
              <Link href={`${siteUrl}/perfil/${data.freelancer.id}`}>
  ...
  return (
    <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6 border border-slate-200">
      ...
      <div className="grid grid-cols-2 gap-2">
        <a
          href={`${siteUrl}/portfolio/${encodeURIComponent(data.portfolio.url_slug)}`}
          target="_blank"
        ...
        <a
          href={`${siteUrl}/perfil/${data.freelancer.id}`}
          target="_blank"
          rel="noopener noreferrer"
        >
