...
import { Clock, TrendingUp, Zap, Trophy, Flame } from "lucide-react";
import { StreakWidget } from "@/app/(protected)/dashboard/streak-widget";
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex gap-3 flex-wrap">
        ...
        <LinkButton href="/explore/swipe" variant="default" className="bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700">🔥 Swipe Projetos</LinkButton>
