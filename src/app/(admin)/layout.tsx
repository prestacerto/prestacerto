    ...
    <div className="flex h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <aside className="w-64 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-6">
        ...
        <div className="mt-8 pt-8 border-t border-slate-200 dark:border-slate-800">
          <LogoutButton className="w-full justify-start gap-3 px-4 py-3 font-medium text-red-600 dark:text-red-400 hover:bg-red-50 hover:text-red-700 dark:hover:bg-red-950/30" />
        </div>
      </aside>
