    ...
    <main className="min-h-screen bg-white">
      <nav className="fixed top-0 w-full z-50 bg-white/95 backdrop-blur border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex gap-8 items-center">
            <a href="/projects" className="text-gray-700 hover:text-gray-900 font-medium">Projetos</a>
            <a href="/services" className="text-gray-700 hover:text-gray-900 font-medium">Serviços</a>
            <a href="/plans" className="text-gray-700 hover:text-gray-900 font-medium">Planos</a>
            <a href="/login" className="text-gray-700 hover:text-gray-900 font-medium">Entrar</a>
            <a href="/register" className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold">Registrar</a>
          </div>
        </div>
      </nav>
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-16">
            <a href="/register" className="px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold transition inline-block text-center">
              Começar grátis
            </a>
            <a href="/projects" className="px-8 py-3 border-2 border-gray-900 text-gray-900 rounded-lg hover:bg-gray-50 font-semibold transition inline-block text-center">
              Explorar projetos
            </a>
          </div>
        </div>
      ...
      <section className="bg-blue-600 text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a href="/register" className="inline-block px-8 py-3 bg-white text-blue-600 rounded-lg hover:bg-gray-100 font-semibold transition">
            Criar conta grátis
          </a>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-gray-400 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-gray-800 pt-8 text-sm">
            <p>© 2026 PrestaCerto. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </main>
