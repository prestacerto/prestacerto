...
const SITE_URL = (process.env.NEXT_PUBLIC_SITE_URL || process.env.NEXT_PUBLIC_APP_URL || 'https://prestacerto.com.br').replace(/\/$/, '');
const LINKEDIN_REDIRECT_URI = process.env.LINKEDIN_REDIRECT_URI || `${SITE_URL}/api/integrations/linkedin/callback`;
