...
export const metadata = getPageMetadata('Política de privacidade', 'Saiba como o PrestaCerto trata dados pessoais, quais informações são utilizadas e como entrar em contato sobre privacidade.', "/privacidade");
...
publicados, propostas enviadas, mensagens, avaliações. Dados de assinatura: identificação da conta, plano e situação da cobrança
processada pelo Assiny. O pagamento pelo serviço profissional é combinado
e realizado diretamente entre cliente e profissional, fora do fluxo de
assinatura da plataforma. Ao usar o Certo AI, o texto que você fornece é
enviado ao provedor de IA para gerar a sugestão.`,
  },
  {
    title: "3. Como usamos os dados",
    body: `Usamos seus dados para: criar e manter sua conta; conectar clientes
e freelancers; gerenciar assinaturas processadas pelo Assiny; calcular sua nota de
...
plataforma: Supabase (banco de dados e autenticação), Assiny
(processamento de assinaturas), OpenAI (sugestões do Certo AI) e Resend
(envio de e-mails).
