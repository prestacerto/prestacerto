...
export const metadata = getPageMetadata('Ranking de indicações', 'Consulte o ranking de indicações do PrestaCerto e entenda quais indicações são contabilizadas na plataforma.', "/indicacoes");
