...
export const metadata: Metadata = getPageMetadata('Aprenda a cobrar melhor e apresentar propostas', 'Dicas curtas e práticas de precificação, propostas, posicionamento e relação com cliente. Leituras de 30 segundos para freelancers brasileiros.', '/aprenda');
