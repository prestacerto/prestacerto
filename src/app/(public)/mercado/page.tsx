...
export const metadata = { ...getPageMetadata('Mercado freelancer: dados e orçamentos', 'Consulte os dados disponíveis sobre projetos, orçamentos e habilidades na plataforma. Veja a origem das informações e a disponibilidade de amostras.', '/mercado'), robots: { index: false, follow: true } };

async function getMarketData() {
  if (!hasServiceCredentials()) {
    return { stats: [], trendingSkills: [], totalOpen: 0 };
  }
    ...
    <div className="mx-auto w-full max-w-4xl px-4 py-12 sm:px-6">
      <div className="text-center">
        ...
        <h1 className="mt-4 text-3xl font-bold text-slate-900 dark:text-slate-100 sm:text-4xl">
          Projetos e preços no PrestaCerto
        </h1>
        <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-600 dark:text-slate-400">
          Orçamentos de projetos abertos e valores de propostas aceitas no PrestaCerto. Propostas aceitas não comprovam pagamento pelo serviço.
      ...
      <p className="mt-8 text-center text-xs text-muted-foreground">
        Dados dos projetos disponíveis no PrestaCerto, atualizados a cada hora. A amostra pode variar e não representa todo o mercado freelancer.
      </p>
    </div>
  );
}
